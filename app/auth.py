...
def register():
    try:
        ...
        if request.method == 'POST':  
            ...
            flash('Please check in your registered email to activate your account','success')
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if password1 != password:
                flash('Both values should be the same','error')
                return render_template('auth/change.html', number=authid)
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if user is not None:
                ...
                flash('Please check in your registered email','success')
            else:
